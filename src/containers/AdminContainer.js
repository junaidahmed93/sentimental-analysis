    ...
    return (
      <div>
        <Grid fluid className="gridMain" style={{ padding: 0, paddingLeft: 2 }}>
          ...
          >
            <div style={{ padding: 0 }} className="sideMenus">
              <Paper className="sideMenusPaper" style={{ width: '80px', height: '100%' }} >
                <Menu>
            ...
            <div style={{ overflowY: 'scroll', padding: 3 }} className="rightSideItems">
              {this.props.children}
            </div>
          </Row>
        </Grid>
